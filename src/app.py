...
def page_today():
    ...
    # ===== 프리셋 (히스토리와 동일) =====
    PRESETS_TODAY = {
        "🥇 시총 500위 (코스피+코스닥, 추천)": (5.466e11, True),
        "⭐ v3.7 (5천억+ + 시장필터)": (5e11, True),
...
def page_backtest():
    ...
    PRESETS_BT = {
        "🥇 시총 500위 (코스피+코스닥, 추천)": (5.466e11, True, 2.43, 4.00, 500),
        "⭐ v3.7 — 시총 5천억+": (5e11, True, 2.48, 3.94, 565),
...
def page_history():
    ...
    # ===== 1) 프리셋 =====
    PRESETS_HIST = {
        "🥇 시총 500위 (코스피+코스닥, 추천)": (5.466e11, True, 2.43),
        "⭐ v3.7 (5천억+ + 시장필터)": (5e11, True, 2.48),
